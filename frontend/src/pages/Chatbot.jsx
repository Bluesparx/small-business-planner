  ...
  return (
    <div>
      ...
      <div
        ...
        className="fixed bottom-8 right-8 cursor-pointer bg-blue-500 rounded-full p-4 shadow-lg hover:shadow-xl transition-all"
        style={{
          animation: "jump 1s infinite alternate", // Adding the jump animation
        }}
      >
